...
class SegmentedProgressBar : View, Runnable, View.OnTouchListener {
    ...
    var segmentStrokeWidth: Int = resources.getDimensionPixelSize(R.dimen.default_segment_stroke_width)
    ...
    var timePerSegmentMs: Long = 5000.toLong()
